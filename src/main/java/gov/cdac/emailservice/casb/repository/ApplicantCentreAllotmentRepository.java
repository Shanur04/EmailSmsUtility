...
import gov.cdac.emailservice.casb.pojo.CasbApplicantCentreAllotment;
import gov.cdac.emailservice.projection.CentreSlotCandidateCount;

@Repository("casbApplicantCentreAllotmentRepository")
public interface ApplicantCentreAllotmentRepository extends JpaRepository<CasbApplicantCentreAllotment, Long> {
