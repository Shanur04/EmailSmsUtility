...
@NamedQuery(name="CasbEmailSent.findAll", query="SELECT e FROM CasbEmailSent e")
public class CasbEmailSent implements Serializable {
	...
	private List<CasbEmailScheduleDetail> emailScheduleDetails = new ArrayList<>();

	@OneToOne(mappedBy = "emailSent")
	private CasbEmailReportDetail emailReportDetail;

	public CasbEmailSent() {
	}

	public CasbEmailSent(CasbExamMaster exam, Integer candidatesCount, String subject, String body,
	...
	public CasbExamMaster getExam() {
		return exam;
	}

	public void setExam(CasbExamMaster exam) {
		this.exam = exam;
	}
	...
	public List<CasbEmailScheduleDetail> getEmailScheduleDetails() {
		return emailScheduleDetails;
	}

	public void setEmailScheduleDetails(List<CasbEmailScheduleDetail> emailScheduleDetails) {
		this.emailScheduleDetails = emailScheduleDetails;
		for(CasbEmailScheduleDetail esd : emailScheduleDetails) {
