...
@EnableJpaRepositories(entityManagerFactoryRef = "afcatEntityManagerFactory", transactionManagerRef = "afcatTransactionManager", basePackages = "gov.cdac.emailservice.afcat.repository")
public class AFCATDataSource extends HikariConfig {
	...
	return new LocalContainerEntityManagerFactoryBean() {
		...
		setPackagesToScan("gov.cdac.emailservice.afcat.pojo");
