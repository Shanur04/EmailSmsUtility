...
import gov.cdac.emailservice.icg.pojo.CentreMaster;
...
public interface CentreMasterRepository extends JpaRepository<CentreMaster, Integer>{
	...
	@Query("select new gov.cdac.emailservice.models.CentreModel(cem.centreId,cem.centreName,cem.centreCode) from CentreMaster cem "
