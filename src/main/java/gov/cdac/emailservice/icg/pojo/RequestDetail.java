...
public class RequestDetail implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "REQUEST_DETAILS_REQUEST_DETAILS_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "REQUEST_DETAILS_REQUEST_DETAILS_ID_SEQ")
	...
	public AllocationChangeLevelMaster getAllocationChangeLevelMaster() {
		return this.allocationChangeLevelMaster;
	}

	public void setAllocationChangeLevelMaster(AllocationChangeLevelMaster allocationChangeLevelMaster) {
		this.allocationChangeLevelMaster = allocationChangeLevelMaster;
	}
