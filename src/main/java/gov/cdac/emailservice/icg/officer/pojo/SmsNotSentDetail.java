...
public class SmsNotSentDetail implements Serializable {
    ...
    public SmsNotSentDetail(gov.cdac.emailservice.icg.officer.pojo.ApplicantCredential appCred, String mobileNumber, Object object, IcgOfficerSMSSent smsSent2,
    ...
    public  gov.cdac.emailservice.icg.officer.pojo.ApplicantCredential getApplicantCredential() {
	return applicantCredential;
    }

    public void setApplicantCredential( gov.cdac.emailservice.icg.officer.pojo.ApplicantCredential applicantCredential) {
