...
/**
 * The persistent class for the rps_exam_result database table.
 * 
 */
@Entity
@Table(name="rps_exam_result")
@NamedQuery(name="RpsExamResult.findAll", query="SELECT r FROM RpsExamResult r")
public class RpsExamResult implements Serializable {
	...
	@Column(name="shortlisted_order", length=255)
	private String shortlistedOrder;

	@Column(name="temp_shortlisted", length=1)
	private String tempShortlisted;
	...
	//bi-directional many-to-one association to RpsSectionResult
	@OneToMany(mappedBy="rpsExamResult")
	private List<RpsSectionResult> rpsSectionResults;

	public RpsExamResult() {
	}
	...
	public String getTempShortlisted() {
		return this.tempShortlisted;
	}

	public void setTempShortlisted(String tempShortlisted) {
		this.tempShortlisted = tempShortlisted;
	}
	...
	public List<RpsSectionResult> getRpsSectionResults() {
		return this.rpsSectionResults;
	}

	public void setRpsSectionResults(List<RpsSectionResult> rpsSectionResults) {
		this.rpsSectionResults = rpsSectionResults;
	}

	public RpsSectionResult addRpsSectionResult(RpsSectionResult rpsSectionResult) {
		getRpsSectionResults().add(rpsSectionResult);
		rpsSectionResult.setRpsExamResult(this);

		return rpsSectionResult;
	}

	public RpsSectionResult removeRpsSectionResult(RpsSectionResult rpsSectionResult) {
		getRpsSectionResults().remove(rpsSectionResult);
		rpsSectionResult.setRpsExamResult(null);
