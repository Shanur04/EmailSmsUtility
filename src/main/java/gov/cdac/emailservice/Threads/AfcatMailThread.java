...
public class AfcatMailThread extends Thread{
	 ...
	 */
	public AfcatMailThread(String mailServerHost,String mailServerPort,Boolean starttls,String socketFactoryPort, String mailUserName, String mailPassword, String mailSubject,String mailContent,
