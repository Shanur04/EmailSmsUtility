...
@Repository("afcatEmailTextReportDetailsRepository")
public interface EmailTextReportDetailsRepository extends JpaRepository<AfcatEmailTextReportDetails, Long>{
