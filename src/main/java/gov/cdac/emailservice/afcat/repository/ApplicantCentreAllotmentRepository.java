...
import gov.cdac.emailservice.afcat.pojo.AfcatApplicantCentreAllotment;
import gov.cdac.emailservice.projection.CentreSlotCandidateCount;

@Repository("afcatApplicantCentreAllotmentRepository")
public interface ApplicantCentreAllotmentRepository extends JpaRepository<AfcatApplicantCentreAllotment, Long> {
