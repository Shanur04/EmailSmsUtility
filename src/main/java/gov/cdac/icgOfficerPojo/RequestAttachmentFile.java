...
public class RequestAttachmentFile implements Serializable {
	...
	@Id
	@SequenceGenerator(name="REQUEST_ATTACHMENT_FILES_REQUESTATTACHMENTFILESID_GENERATOR" ,allocationSize = 1 )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="REQUEST_ATTACHMENT_FILES_REQUESTATTACHMENTFILESID_GENERATOR")
