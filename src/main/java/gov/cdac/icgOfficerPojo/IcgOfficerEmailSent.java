...
@NamedQuery(name="IcgOfficerEmailSent.findAll", query="SELECT e FROM IcgOfficerEmailSent e")
public class IcgOfficerEmailSent implements Serializable {
	...
	private List<IcgOfficerEmailScheduleDetail> emailScheduleDetails = new ArrayList<>();

	@OneToOne(mappedBy = "emailSent")
	private IcgOfficerEmailReportDetail emailReportDetail;

	public IcgOfficerEmailSent() {
	}

	public IcgOfficerEmailSent(ExamMaster exam, Integer candidatesCount, String subject, String body,
	...
	public List<IcgOfficerEmailScheduleDetail> getEmailScheduleDetails() {
		return emailScheduleDetails;
	}

	public void setEmailScheduleDetails(List<IcgOfficerEmailScheduleDetail> emailScheduleDetails) {
		this.emailScheduleDetails = emailScheduleDetails;
		for(IcgOfficerEmailScheduleDetail esd : emailScheduleDetails) {
	...
	public void getHelperScheduler(IcgOfficerEmailScheduleDetail emailScheduleDetail) {
