...
public class ExamCitySubcityMapping implements Serializable {
	...
	@Id
	@SequenceGenerator(name="EXAMCITYSUBCITYMAPPINGID_GENERATOR", allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="EXAMCITYSUBCITYMAPPINGID_GENERATOR")
