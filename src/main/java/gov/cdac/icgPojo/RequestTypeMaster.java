...
public class RequestTypeMaster implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "REQUEST_TYPE_MASTER_REQUEST_TYPE_MASTER_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "REQUEST_TYPE_MASTER_REQUEST_TYPE_MASTER_ID_SEQ")
