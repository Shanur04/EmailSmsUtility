...
public class IcgEmailSent implements Serializable {
	...
	private List<IcgEmailScheduleDetail> emailScheduleDetails = new ArrayList<>();
	
//	@Fetch(FetchMode.JOIN)
//	@OneToMany(mappedBy = "emailSent", cascade = CascadeType.ALL)
//	private List<IcgEmailTextReportDetails> emailTextReports = new ArrayList<>();
	...
	public IcgEmailSent(ExamMaster exam, Integer candidatesCount, String subject, String body,
			Timestamp emailStartDatetime, int emailSentType, Boolean emailSentStatus, String reqType,
			String reasonForEmail, String mailServerHost, String mailServerPort, Boolean starttls,
	...
	public IcgEmailSent(ExamMaster exam, Integer candidatesCount, String subject, String body, String reasonForEmail,
			Timestamp emailStartDatetime, int emailSentType, Boolean emailSentStatus, String reqType, String mailServerHost,
			String mailServerPort, Boolean starttls, String socketFactoryPort, String sendAdmitCardsRadio, String slots,
			String centers, String emailBreathingTime, String emailsPerBatch) {
		super();
		this.exam = exam;
		this.candidatesCount = candidatesCount;
		this.subject = subject;
	...
	public List<IcgEmailScheduleDetail> getEmailScheduleDetails() {
		return emailScheduleDetails;
	}

	public void setEmailScheduleDetails(List<IcgEmailScheduleDetail> emailScheduleDetails) {
		this.emailScheduleDetails = emailScheduleDetails;
		
		for(IcgEmailScheduleDetail esd : emailScheduleDetails) {
			esd.setEmailSent(this);
		}
	}
	
	public void getHelperScheduler(IcgEmailScheduleDetail emailScheduleDetail) {
	...
	public String toString() {
		return "EmailSent [emailSentId=" + emailSentId + ", candidatesCount=" + candidatesCount
				+ ", subject=" + subject + ", body=" + body + ", reasonForEmail=" + reasonForEmail + ", isAttachment="
				+ isAttachment + ", attachmentPath=" + attachmentPath + ", attachmentCount=" + attachmentCount
				+ ", recordTracking=" + recordTracking + ", emailStartDatetime=" + emailStartDatetime
				+ ", emailEndDatetime=" + emailEndDatetime + ", emailSentType=" + emailSentType + ", emailSentStatus="
				+ emailSentStatus + ", reqType=" + reqType + ", mailServerHost=" + mailServerHost + ", mailServerPort="
				+ mailServerPort + ", starttls=" + starttls + ", socketFactoryPort=" + socketFactoryPort + "]";
	}
}