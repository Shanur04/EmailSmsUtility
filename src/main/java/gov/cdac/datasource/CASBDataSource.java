...
@EnableJpaRepositories(entityManagerFactoryRef = "casbEntityManagerFactory", transactionManagerRef = "casbTransactionManager", basePackages = "gov.cdac.casbRepository")
public class CASBDataSource extends HikariConfig {
	...
	return new LocalContainerEntityManagerFactoryBean() {
		...
		setPackagesToScan("gov.cdac.casbPojo");
